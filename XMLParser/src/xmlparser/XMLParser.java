        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                writer.write("\t<update>\n"
                             ...
                             + "\t\t</temp>\n"
                             + "\t\t<solar>\n"
                             + "\t\t\t<solarad flag=\"" + updateData[8] + "\">\n"
                             + "\t\t\t\t" + updateData[7] + "\n"
                             + "\t\t\t</solarad>\n"
                             + "\t\t\t<solarad_max flag=\"" + updateData[10] + "\">\n"
                             + "\t\t\t\t" + updateData[9] + "\n"
                             + "\t\t\t</solarad_max>\n"
                             + "\t\t\t<solarad_min flag=\"" + updateData[12] + "\">\n"
                             + "\t\t\t\t" + updateData[11] + "\n"
                             + "\t\t\t</solarad_min>\n"
                             + "\t\t</solar>\n"
                             + "\t\t<sur type=\"" + updateData[13] + "\">\n"
                             + "\t\t\t<sur_temp flag=\"" + updateData[15] + "\">\n"
                             + "\t\t\t\t" + updateData[14] + "\n"
                             + "\t\t\t</sur_temp>\n"
                             + "\t\t\t<sur_temp_max flag=\"" + updateData[17] + "\">\n"
                             + "\t\t\t\t" + updateData[16] + "\n"
                             + "\t\t\t</sur_temp_max>\n"
                             + "\t\t\t<sur_temp_min flag=\"" + updateData[19] + "\">\n"
                             + "\t\t\t\t" + updateData[18] + "\n"
                             + "\t\t\t</sur_temp_min>\n"
                             + "\t\t</sur_temp>\n"
                             + "\t\t<rh_hr_avg flag=\"" + updateData[21] + "\">\n"
                             + "\t\t\t" + updateData[20] + "\n"
                             + "\t\t</rh_hr_avg>\n"
                             + "\t\t<soil>\n"
                             + "\t\t\t<moisture_50>\n"
